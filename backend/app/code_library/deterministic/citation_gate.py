...
Two modes:
  ...
  - enforce=False (LLM department findings): ENRICH only. Attach verbatim
    ...
    downgrade — the corpus is too thin to be authoritative against, and the
    department reviews stand on their own retrieval.
...
class _CorpusProbe:
    ...
    A tiny duck-typed protocol keeps this testable with a fake.
    """
...
def apply_citation_gate(
    ...
    *,
    ...
    NEEDS_REVIEW with a flag appended to the description.
    """
